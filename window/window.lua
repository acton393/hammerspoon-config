...
hs.hotkey.bind({"ctrl",        "cmd", "shift"}, "Left",  hs.fnutils.partial(winresize, "left"))
hs.hotkey.bind({"ctrl",        "cmd", "shift"}, "Right", hs.fnutils.partial(winresize, "right"))
hs.hotkey.bind({"ctrl",        "cmd", "shift"}, "Up",    hs.fnutils.partial(winresize, "up"))
